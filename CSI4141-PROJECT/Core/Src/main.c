...
int main(void)
{
  ...
  MotorTaskHandle = osThreadNew(MotorTask1, NULL, &MotorTask_attributes);

  /* creation of UI_Task */
  UI_TaskHandle = osThreadNew(MyUI_Task, NULL, &UI_Task_attributes);
...
/* USER CODE BEGIN Header_MotorTask1 */
/**
* @brief Function implementing the MotorTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_MotorTask1 */
void MotorTask1(void *argument)
{
...
/* USER CODE BEGIN Header_MyUI_Task */
/**
* @brief Function implementing the UI_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_MyUI_Task */
void MyUI_Task(void *argument)
{
